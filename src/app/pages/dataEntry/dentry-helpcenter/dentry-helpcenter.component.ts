...
@Component({
  selector: 'app-dentry-helpcenter',
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
  templateUrl: './dentry-helpcenter.component.html',
  styleUrl: './dentry-helpcenter.component.scss'
})
export class DentryHelpcenterComponent implements OnInit, OnDestroy {
